# Colab cells for R1_single_view_strict
...
```text
MyDrive/finetune_IU_Xray_phase2/R1_single_view_strict/
  R1_single_view_strict_bundle.zip
  R1_single_view_strict_colab_cells.md
```
...
PACKAGE_NAME = "R1_single_view_strict"
BUNDLE_ZIP = f"{DRIVE_ROOT}/{PACKAGE_NAME}/R1_single_view_strict_bundle.zip"

REPO_DIR = "/content/finetune_IU_Xray"
RUN_NAME = "R1_single_view_strict_150ep"
