# Colab cells for R3_cluster_guided_basic
...
```text
MyDrive/finetune_IU_Xray_phase2/R3_cluster_guided_basic/
  R3_cluster_guided_basic_bundle.zip
  R3_cluster_guided_basic_colab_cells.md
```
...
PACKAGE_NAME = "R3_cluster_guided_basic"
BUNDLE_ZIP = f"{DRIVE_ROOT}/{PACKAGE_NAME}/R3_cluster_guided_basic_bundle.zip"

REPO_DIR = "/content/finetune_IU_Xray"
RUN_NAME = "R3_cluster_guided_basic_150ep"
