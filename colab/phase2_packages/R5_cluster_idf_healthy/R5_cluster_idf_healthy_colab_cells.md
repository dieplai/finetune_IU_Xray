# Colab cells for R5_cluster_idf_healthy
...
```text
MyDrive/finetune_IU_Xray_phase2/R5_cluster_idf_healthy/
  R5_cluster_idf_healthy_bundle.zip
  R5_cluster_idf_healthy_colab_cells.md
```
...
PACKAGE_NAME = "R5_cluster_idf_healthy"
BUNDLE_ZIP = f"{DRIVE_ROOT}/{PACKAGE_NAME}/R5_cluster_idf_healthy_bundle.zip"

REPO_DIR = "/content/finetune_IU_Xray"
RUN_NAME = "R5_cluster_idf_healthy_150ep"
