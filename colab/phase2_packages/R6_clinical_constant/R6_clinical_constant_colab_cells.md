# Colab cells for R6_clinical_constant
...
```text
MyDrive/finetune_IU_Xray_phase2/R6_clinical_constant/
  R6_clinical_constant_bundle.zip
  R6_clinical_constant_colab_cells.md
```
...
PACKAGE_NAME = "R6_clinical_constant"
BUNDLE_ZIP = f"{DRIVE_ROOT}/{PACKAGE_NAME}/R6_clinical_constant_bundle.zip"

REPO_DIR = "/content/finetune_IU_Xray"
RUN_NAME = "R6_clinical_constant_150ep"
