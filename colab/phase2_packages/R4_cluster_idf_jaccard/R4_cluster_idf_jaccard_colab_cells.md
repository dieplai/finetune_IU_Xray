# Colab cells for R4_cluster_idf_jaccard
...
```text
MyDrive/finetune_IU_Xray_phase2/R4_cluster_idf_jaccard/
  R4_cluster_idf_jaccard_bundle.zip
  R4_cluster_idf_jaccard_colab_cells.md
```
...
PACKAGE_NAME = "R4_cluster_idf_jaccard"
BUNDLE_ZIP = f"{DRIVE_ROOT}/{PACKAGE_NAME}/R4_cluster_idf_jaccard_bundle.zip"

REPO_DIR = "/content/finetune_IU_Xray"
RUN_NAME = "R4_cluster_idf_jaccard_150ep"
